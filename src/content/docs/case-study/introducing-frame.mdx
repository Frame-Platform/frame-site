...
import searchByImage from "/public/assets/search-by-image.mp4";
import searchByText from "/public/assets/search-by-text.mp4";
import recommendations from "/public/assets/recommendations.mp4";
...
<img src={cliGif.src} alt="CLI Screenshot" />
...
<img src={sdkImage.src} alt="SDK Screenshot" />
...
<video autoplay loop muted playsinline width="100%" height="auto">
  <source src="/assets/search-by-text.mp4" type="video/mp4">
...
<video autoplay loop muted playsinline width="100%" height="auto">
  <source src="/assets/search-by-image.mp4" type="video/mp4">
  Your browser does not support the video tag.
  </source>
</video>
...
<video autoplay loop muted playsinline width="100%" height="auto">
  <source src="/assets/recommendations.mp4" type="video/mp4">
  Your browser does not support the video tag.
  </source>
</video>
