...
<figure>
  <img src={diagram3.src} alt="Ranking based on download counts: popular content appears while new content is buried" />
  <figcaption>Ranking based on download counts: popular content appears while new content is buried</figcaption>
</figure>
...
<figure>
  <img src={diagram4.src} alt="An image of a dog transformed through an embedding model into its lower-dimensional vector representation" />
  <figcaption>An image of a dog transformed through an embedding model into its lower-dimensional vector representation</figcaption>
</figure>
...
<figure>
  <img src={diagram6.src} alt="Vector embeddings positioned in a 3D coordinate space"/>
...
<figure>
  <img src={diagram7.src} alt="Comparison of cosine similarity: similar vectors (two dogs) with a small angle versus different vectors (dog and sunset) with a large angle"/><figcaption>Comparison of cosine similarity: similar vectors (two dogs) with a small angle versus different vectors (dog and sunset) with a large angle </figcaption>
</figure>
...
<figure>
  <img src={diagram8.src} alt="Similar cloud paintings clustered together in vector space (nearest neighbors)"/>
  <figcaption>Similar cloud paintings clustered together in vector space (nearest neighbors)</figcaption>
</figure>
...
<figure>
  <img src={diagram9.src} alt="Multimodal embedding comparison: similar vectors (‘Dog’ text and dog image) with a small angle versus different vectors (‘Gandalf’ text and dog image) with a large angle"/><figcaption>Multimodal embedding comparison: similar vectors (‘Dog’ text and dog image) with a small angle versus different vectors (‘pterodactyl’ text and dog image) with a large angle</figcaption>
</figure>
...
<figure>
  <img src={diagram10.src} alt="Semantic clustering of related dog (text and image) content in multimodal embedding space"/>
  <figcaption>Semantic clustering of related dog (text and image) content in multimodal embedding space</figcaption>
</figure>
