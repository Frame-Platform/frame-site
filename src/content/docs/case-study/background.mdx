...
<figure>
  <img
    src={diagram9.src}
    alt="Multimodal embedding comparison: similar vectors (‘Dog’ text and dog image) with a small angle versus different vectors (‘Gandalf’ text and dog image) with a large angle"
  />
  <figcaption>
