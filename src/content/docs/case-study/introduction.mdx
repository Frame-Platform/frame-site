...
<figure>
  <img src={diagram1.src} alt="Frame is a deployable infrastructure that implements the core features of an image search platform: search by description, search by image, recommendations, and uploading and embedding of images."/>
  <figcaption>Frame is a deployable infrastructure that implements the core features of an image search platform: search by description, search by image, recommendations, and uploading and embedding of images.</figcaption>
</figure>
